    ...
    <form action="{{URL::to('/results-example-test')}}" method="post"  >
        ...
        <div id="form_listening" class="containerAnswer container mt-sm-5 my-1">
            ...
            <div class="form-wizard">
               ...
               {{--      ================================================================================================ --}}
                    @foreach($all_part_listens as $k => $all_part_listen)
                    <fieldset class="wizard-fieldset show">
                        <section>
                            ...
                            @foreach($all_topic_listens as $k => $all_topic_listen)
                            <div class="mcq-wrapper " id="mau">
                                ...
                                <div >
                                    ...
                                    <audio controls >   
                                        <source src="{{asset('/uploads/audio/'.$all_topic_listen->topic_audio)}}" type="audio/mpeg">
                                        <source src="{{asset('/uploads/audio/'.$all_topic_listen->topic_audio)}}" type="audio/ogg">
                                        
                                    </audio>
                                
                                </div>
                                @foreach($all_ques_listens as $k => $all_ques_listen)
                                <span class="question-content empty-question-content">{{$all_ques_listen->question_content}}</span>
                                ...
                                {{-- <div class="options-wrapper">
                                    ...
                                    <div class="option">
                                            ...
                                            <input value="{{$answers->answer_id}}" type='radio' name="nameListen[{{$all_part1s->question_id}}]" id="id[{{$answers->answer_id}}]"  />
                            ...
                            @foreach($all_part2 as $k => $all_part2s)
                                <div class="py-2 h5 au ">
                                    ...
                                    <audio controls id="au2" >
                                        ...
                                        <source src="{{asset('/uploads/audio/'.$all_part2s['topic_audio'])}}" type="audio/mpeg">
                                        <source src="{{asset('/uploads/audio/'.$all_part2s['topic_audio'])}}" type="audio/ogg">
                                        <script>
                            ...
                            <div class="mcq-wrapper">
                                ...
                                <div class="options-wrapper">
                                    ...
                                    <div class="option">
                                            ...
                                            <input value="{{$answers->answer_id}}" type='radio' name="nameListen[{{$all_quess->question_id}}]" id="id[{{$answers->answer_id}}]"  />
                                            <label for="id[{{$answers->answer_id}}]">{{$ans1[$index++].' '.$answers->answer_content}}
                                            </label>
                            ...
                            @foreach($all_part3 as $k => $all_part3s)
                                <div class="py-2 h5 au ">
                                    ...
                                    <audio controls id="au2" >
                                        ...
                                        <source src="{{asset('/uploads/audio/'.$all_part3s->topic_audio)}}" type="audio/mpeg">
                                        <source src="{{asset('/uploads/audio/'.$all_part3s->topic_audio)}}" type="audio/ogg">
                                        <script>
                                            au2.onended = function() {
                                            var au3 = document.getElementById("au3");
                                            au3.play();
                    ...
                    <section>
                        ...
                        <div class="directions">
                            ...
                            @foreach($all_read1 as $key => $all_read1s)
                                ...
                                @if($all_quess->topic_id==$all_read1s->topic_id && $dem < $all_read1s->part_amount_ques_per_topic)
                                <?php $dem++; ?>
                                <div class="mcq-wrapper">
                                        ...
                                        <div class="options-wrapper">
                                            ...
                                            <div class="option">
                                                ...
                                                <input id="id[{{$answers->answer_id}}]" type='radio' name="nameRead[{{$all_quess->question_id}}]" value="{{$answers->answer_id}}" />
                        ...
                        <fieldset class="wizard-fieldset">
                           ...
                           <section>
                            ...
                            @foreach($all_read2 as $key => $all_read2s)
                                ...
                                @foreach($all_ques as $key => $all_quess)
                                @if($all_quess->topic_id==$all_read2s->topic_id && $dem < $all_read2s->part_amount_ques_per_topic)
                                <?php $dem++; ?>
                                <div class="mcq-wrapper">
                    ...
                    <section>
                        ...
                        <div style="margin-top: 10px">
                            @foreach($all_read3 as $key => $all_read3s)
                                ...
                                @foreach($all_ques as $key => $all_quess)
                                @if($all_quess->topic_id==$all_read3s->topic_id && $dem < $all_read2s->part_amount_ques_per_topic)
                                <?php $dem++; ?>
                                <div class="mcq-wrapper">
