        ...
        <div class="form-wizard">
            <form id="result_level" action="{{URL::to('/results-level-test')}}" method="post" role="form">
              @csrf
                ...
                <fieldset class="wizard-fieldset show">
                    ...
                    <section>
                       ...
                       @foreach($all_part1 as $k => $all_part1s)
                        ...
                        $ans = array("(A)","(B)","(C)" );
                        ?>
                        @foreach($all_part1 as $key => $all_ques_part1s)
                            @if($all_part1s->topic_id==$all_ques_part1s->topic_id)
                            <div class="mcq-wrapper">
                                ...
                                <span class="question-content empty-question-content">{{$all_ques_part1s->question_content}}</span>
                                <br>
                                   ...
                                   {{--  <?php $index=0; ?>
                                    ...
                                    <div class="option">
                                        @if($all_listen_test_part2s->question_id==$answers->question_id)
                                            <input value="{{$answers->answer_id}}" type='radio' name="nameListen[{{$all_listen_test_part2s->question_id}}]" id="id[{{$answers->answer_id}}]"  />
                       ...
                       {{--  @foreach($all_part2 as $key => $all_part2s)
                        ...
                        ?>
                            <div class="mcq-wrapper">
                                ...
                                <div >
                                    @foreach($all_ques_part2 as $k => $all_ques_part2s )
                                        @if($all_ques_part2s->topic_id == $all_part2s->topic_id)
                                            <span class="question-content empty-question-content">{{$all_ques_part2s->question_content}}</span>
                                        @endif
                                    <br>
                                    <div class="options-wrapper">
                                        <?php $index=0; ?>
                ...
                <fieldset class="wizard-fieldset">
                   ...
                   <section>
                       ...
                       {{--  @foreach($all_part2 as $key => $all_part2s)
                        ...
                        $ans = array("(A)","(B)","(C)" );
                        ?>
                        @foreach($all_ques_part2 as $key => $all_ques_part2s)
                            @if($all_part2s->topic_id==$all_ques_part2s->topic_ids)
                            <div class="mcq-wrapper">
                                <span class="question-num"><?php
                                        echo $i.'.';
                                        $i++;
                                ...
                                <span class="question-content empty-question-content">{{$all_ques_part2->question_content}}</span>
                                <br>
                                <div class="options-wrapper">
                                   {{--  <?php $index=0; ?>
                                    @foreach($all_answer as $key => $answers)
                ...
                <div >
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#readingModel">
                        Launch demo modal
                    </button>
                </div>
