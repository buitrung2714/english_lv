...
{{-- <?php
    ...
    if($re)
    {
        ...
        echo 'alert("Log in to continue testing2222222222222!!!!!!")';  
        echo '</script>';
        Session::put('re',null);
    }
