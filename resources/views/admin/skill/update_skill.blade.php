...
<nav aria-label="breadcrumb">
	<ol class="breadcrumb">
		<li class="breadcrumb-item"><a href="{{ URL::to('/admin/skills') }}">Skills Manage</a></li>
	...
	<div class="forms-grids">
		<div class="w3agile-validation">
			...
			<div class="panel panel-widget agile-validation">
				<div class="my-div">				
					<form id="form_update" method="post" action="{{URL::to('/admin/update-skill-control/'.$skills->skill_id)}}">
						@csrf
						...
						<div class="form-group">
							<input type="text" name="skill_name" value="{{ $skills->skill_name }}" class="form-control">
						</div>
						<p>
